...
export function getSidebarMenuForUser(role, permissions = [], userRoleId = null) {
  ...
  const menuDefinitions = [
    ...
    // Batches
    { name: 'Batches', href: '/dashboard/batch', icon: 'DoorOpen', 
    ...
    // Classroom
    { name: 'Classrooms', href: '/dashboard/classroom', icon: 'DoorOpen', 
      ...
      // Classroom
    { name: 'Exam', href: '/dashboard/exam', icon: 'Building', 
      show: hasAny('MANAGE_EXAM', 'CREATE_EXAM', 'READ_EXAM', 'UPDATE_EXAM', 'DELETE_EXAM', 'VIEW_EXAM') || hasPattern('_CLASSROOM') },
